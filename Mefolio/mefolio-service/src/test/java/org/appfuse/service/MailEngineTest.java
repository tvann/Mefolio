...
//    If you want to test with an real email server, config the server in mail.properties file and uncomment the Autowired
//    @Autowired
//    JavaMailSenderImpl mailSender;
    ...
    public void testSend() throws Exception {
        ...
        Date dte = new Date();
        this.mailMessage.setTo("nghia.tranv@gmail.com");
