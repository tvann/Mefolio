...
<body<decorator:getProperty property="meta.viewport" writeEntireProperty="true"/><decorator:getProperty property="body.class" writeEntireProperty="true"/>>
